...
internal partial class NumberSequenceRepositorySqLite : INumberSequenceRepository
{
    private readonly IDbTransaction _dbTransaction;
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IDbConnection _sqlConnection;

    public NumberSequenceRepositorySqLite(IDbConnection sqlConnection, IDbTransaction dbTransaction,
