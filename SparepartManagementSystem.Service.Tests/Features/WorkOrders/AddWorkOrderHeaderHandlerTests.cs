...
public class AddWorkOrderHeaderHandlerTests
{
    ...
    public async Task Handle_WhenRepositorySucceeds_AddsHeaderAndCommits()
    {
        ...
        repositoryMock.Setup(repository => repository.Add(It.IsAny<WorkOrderHeader>(), It.IsAny<EventHandler<AddEventArgs>>(), null))
    ...
    public async Task AddWorkOrderHeader_WhenCalled_DelegatesToHandler()
    {
        ...
        addHeaderHandlerMock.Setup(handler => handler.Handle(dto))
        ...
        addHeaderHandlerMock.Verify(handler => handler.Handle(dto), Times.Once);
    }
    ...
    public async Task Handle_WhenRepositoryThrows_RollsBackAndReturnsErrorResponse()
    {
        ...
        var expectedException = new InvalidOperationException("header add failed");
